...
public class CombateTest {
    ...
    void testInitialCombat() {
        ...
        Character newCharacter = CharacterFactory.createCharacter("vampire", "newBot", 100, 100, 10, 0, 0, 0);
        Character secondCharacter = CharacterFactory.createCharacter("hunter", "secondBot", 100, 100, 10, 0, 0, 0);
