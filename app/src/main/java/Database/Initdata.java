...
public class Initdata implements Serializable {
  ...
  private static final String FILENAME =
    "app\\src\\main\\java\\Database\\DatabaseFile\\users.dat";
  private static final String INVENTORY =
    "app\\src\\main\\java\\Database\\DatabaseFile\\inventory.dat";
  private static final String COMBATES =
    "app\\src\\main\\java\\Database\\DatabaseFile\\combates.dat";
  ...
  public static void generateInitialInventories() {
    if (
      !inventories.getWeapons().isEmpty() && !inventories.getArmors().isEmpty()
    ) {
      return;
    }
